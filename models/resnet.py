...
def resnet8x4(**kwargs):
    ...
    #if opt.clip_mode == 'RN50':
    #return ResNet(8, [32, 64, 128, 1024], 'basicblock', **kwargs)
    #if opt.clip_mode == 'RN101' or opt.clip_mode == 'ViT-B/32' or opt.clip_mode == 'ViT-B/16':
    #return ResNet(8, [32, 64, 128, 512], 'basicblock', **kwargs)
